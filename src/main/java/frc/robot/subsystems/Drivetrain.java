...
public class Drivetrain extends SubsystemBase {
  ...
  public void periodic() {
    SmartDashboard.putNumber("leftSpeed", leftMaster.getSensorCollection().getIntegratedSensorVelocity());
    SmartDashboard.putNumber("rightSpeed", rightMaster.getSensorCollection().getIntegratedSensorVelocity());
  }
